...
class _TasksListState extends State<TasksList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      physics:
          widget.item != null ? const NeverScrollableScrollPhysics() : null,
      shrinkWrap: true,
      ...
      itemBuilder: (ctx, index) {
        ...
        if (filteredTasks[keys[index]] != null) {
          for (var task in filteredTasks[keys[index]]!) {
            ...
            final taskDate = dateFormat.parse(dateFormat.format(task.date));
              ...
              confirmDismiss: (direction) async {
                ...
                if (direction == DismissDirection.startToEnd) {
                  ...
                  if (task.type == TaskType.inspection) {
                    ...
                    if (exit == false) {
                      ScaffoldMessenger.of(context)
                        ...
                        ..showSnackBar(
                          SnackBar(
                            content: const Text('Rapid Complete canceled!'),
                  ...
                  if (task.taskInterval != null && task.taskInterval != 'No') {
                    DateCalc.getNextDate(task.nextDate!, task.taskInterval!);
                  }
